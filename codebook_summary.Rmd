...
This dataset contains the independent, tidy dataset as required from Requirement 5 of the assignment.
It is the combined train and test data, grouped by subject and activity.  Each 'feature' measurement 
is then expressed the average for that subject/activity combination.
 ...
 *  Created by: Gareth Coffey (username: `garethcoffey`).

 *  Report creation time: Sun Apr 26 2020 14:15:49

 *  Report was run from directory: `/Users/garethcoffey/Documents/RStudio/Getting and Cleaning Data/Week 4/CleaningData-Week4-Assignment`
...
"visualize", "check"), smartNum = FALSE, file = "codebook_summary.Rmd", 
    ...
    listChecks = FALSE, maxProbVals = Inf, codebook = TRUE, reportTitle = "Codebook for summary")`
