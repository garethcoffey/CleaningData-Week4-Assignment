...
This dataset is the combined 'train' and 'test' datasets, after having:
1. Added the train and test subjects as the first variable
2. Added the descriptive activity as the second variable
3. Renaming the variables to be descriptive as detailed in 'features.txt' 
 ...
 *  Report creation time: Sun Apr 26 2020 14:12:35
